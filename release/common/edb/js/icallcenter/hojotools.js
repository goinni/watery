...
icallcenter.hojotools.input = function(connectType) {
    ...
    //    								"<img src='/components/edb/imgs/tinybox/close_1.gif' onmouseover=\"this.src='/components/edb/imgs/tinybox/close_2.gif'\" onmouseout=\"this.src='/components/edb/imgs/tinybox/close_1.gif'\" />" +
    //    							"</a>" +
    //    						"</div>" +
...
icallcenter.hojotools.loading = function(message, parentId) {
	...
	console(message, parentId);
	   ...
	   // msgObj.innerHTML = "<div style='height:20px;overflow:hidden;text-align:center'><img src='/components/edb/imgs/loading.gif' style='float:left;margin-top:5px;' /><div id='hollyc5.loading.message' style='float:left;color:#666666;padding-left:5px;'>" + message + "</div><div style='clear:both;height:1px;overflow:hidden'>&nbsp;</div></div>";
...
icallcenter.hojotools.error = function(message) {
	// alert(message);
    //异常回调
    callCenterHojotoolError && callCenterHojotoolError.call(this, message);
	console.log(message);
	// var msgw,msgh,bordercolor;
	// msgw=249;
 //    msgh=152;
 ...
 //    msgObj.style.font="12px/1.6em Verdana, Geneva, Arial, Helvetica, sans-serif";
 //    msgObj.style.marginLeft = "-135px" ;
 //    msgObj.style.paddingBottom = "10px" ;
 //    msgObj.style.marginTop = -75+document.documentElement.scrollTop+"px";
 //    msgObj.style.width = msgw + "px";
 ...
 //    msgObj.style.lineHeight ="25px";
 //    msgObj.style.zIndex = "10001";
 //    msgObj.innerHTML = "<div style='height:27px;background: #f3f3f3;overflow:hidden;'><img src='/components/edb/imgs/error.jpg' style='float:left;' /><div style='float:right;margin-right:10px;'><a href='javascript:icallcenter.hojotools.close();'><img src='/components/edb/imgs/tinybox/close_1.gif' style='cursor: pointer;border:0px;' /></a></div></div>"+
 //        					"<div style='height:auto;overflow:hidden;'><div style='float:left;color:#666666;font-size:12px; line-height: 20px; margin: 10px 20px;'>"+message+"</div></div>"+
 //        					"<div style='clear:both;height:1px;overflow:hidden'>&nbsp;</div>"+
 //        					"<div style='padding-left:180px;'><a href='javascript:icallcenter.hojotools.close();'><img src='/components/edb/imgs/confirm_1.jpg' onmouseover=\"this.src='/components/edb/imgs/confirm_2.jpg'\" onmouseout=\"this.src='/components/edb/imgs/confirm_1.jpg'\" style='cursor: pointer;border:0px;' /></a></div>";
...
icallcenter.hojotools.success = function(message) {
	...
	console.log(message);
	   ...
	   // msgObj.innerHTML = "<div style='height:30px;overflow:hidden'><img src='/components/edb/imgs/success.jpg' style='float:left;margin-top:4px;' /><div style='float:left;color:#666666;padding-left:5px;font-size:15px;padding-top:4px'>" + message + "</div><div class='clear1'>&nbsp;</div></div>";
